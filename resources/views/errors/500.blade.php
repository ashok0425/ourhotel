...
<head>
	<title>500 Error| NSN HOTELS</title>
	<meta charset="UTF-8">
...
<style>
		...
		.bg-error-500{
			...
			position: relative;
			background: #eee;
			background: -moz-linear-gradient(top, rgb(183, 226, 223) 0%, rgba(255,255,255,1) 100%); /* FF3.6-15 */
			background: -webkit-linear-gradient(top,rgb(183, 226, 223) 0%,rgba(255,255,255,1) 100%); /* Chrome10-25,Safari5.1-6 */
			background: linear-gradient(to bottom, rgb(183, 226, 223)  0%,rgba(255,255,255,1) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
		...
		.back-btn-500{
			...
			border-radius: 500px;
			background: #ff3366;
			background: -moz-linear-gradient(left, rgb(29,71,131) 0%, rgb(11, 231, 213) 100%); /* FF3.6-15 */
			background: -webkit-linear-gradient(left, rgb(29,71,131) 0%,rgb(11, 231, 213) 100%); /* Chrome10-25,Safari5.1-6 */
			background: linear-gradient(to right, rgb(29,71,131) 0%,rgb(11, 231, 213) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
	...
	<body class="bg-error-500">
		<section class="pd-5vw">
			...
			<div class="">
				<a href="{{url('/')}}"  class="back-btn-500">&larr; Back To Home</a>
			</div>
		</section>
		<div class="error-img">
			<img src="
