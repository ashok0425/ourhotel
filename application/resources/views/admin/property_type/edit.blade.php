...
@section('content')
    <div class="card mb-3">
        <div class="card-body">
                    <h4><strong>Edit Property Type</strong></h4>
            </div>
        </div>
    ...
    <form class="forms-sample" method="POST" action="{{ route('admin.propertyTypes.update',$propertyType) }}">
      @method('PATCH')
              ...
              <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputUsername1"
                        placeholder="Enter meta title for desktop" name="meta_title"  value="{{$propertyType->meta_title}}">
                </div>

                <div class="form-group">
                  <label for="exampleInputUsername1">Meta Keyword For Desktop</label>
                  <input type="text" class="form-control" id="exampleInputUsername1"
                      placeholder="Enter meta keyword for desktop" name="meta_keyword" value="{{$propertyType->meta_keyword}}">
              </div>

              <div class="form-group">
                <label for="exampleInputUsername1">Meta Description For Desktop</label>
                <input type="text" class="form-control" id="exampleInputUsername1"
                    placeholder="Enter meta description for desktop" name="meta_description" value="{{$propertyType->meta_description}}">
            </div>

            <div class="form-group">
              <label for="exampleInputUsername1">Meta Title For Mobile</label>
              <input type="text" class="form-control" id="exampleInputUsername1"
                  placeholder="Enter meta title for mobile" name="mobile_meta_title" value="{{$propertyType->mobile_meta_title}}">
          </div>

          <div class="form-group">
            <label for="exampleInputUsername1">Meta Keyword For Mobile</label>
            <input type="text" class="form-control" id="exampleInputUsername1"
                placeholder="Enter meta keyword for mobile" name="mobile_meta_keyword" value="{{$propertyType->mobile_meta_keyword}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputUsername1"
              placeholder="Enter meta description for mobile" name="mobile_meta_description" value="{{$propertyType->mobile_meta_description}}">
      </div>
