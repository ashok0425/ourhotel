...
<head>
    ...
    <link rel="icon" sizes="16x16"
        href="{{ getImageUrl(setting('logo')) }}">
    <meta name="csrf-token" content="{{ csrf_token() }}" />

    @if (url()->current() == '/')
        <title>Home - NSN Hotels</title>
        <meta name="title" content="The Best Top 10 Online Hotel Booking Websites" />
        <meta name="keyword" content="Best online hotel booking site, online hotel booking sites, online hotel booking websites, websites to book hotels" />
    ...
    <link rel="preload stylesheet"  href="{{filepath('frontend/css/bootstrap.css')}}" as="style" type="text/css" onload="this.rel='stylesheet'">
 @if (request()->path()!='/')
   ...
   <meta name="twitter:card" content="summary_large_image">
    <link rel="preload stylesheet"   href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css" as="style" >
    <link href="{{ filepath('frontend/css/daterangepicker.css') }}" rel="preload stylesheet"  as="style" />
    <link rel="preload stylesheet"  href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.0/css/all.min.css"  as="font" crossorigin>
    <link href="{{ filepath('frontend/css/index/style.css') }}" rel="preload stylesheet"  as="style" type="text/css"/>
    <link href="{{ filepath('frontend/css/index/nsnhotels.css') }}" rel="preload stylesheet"  as="style" type="text/css"/>
...
})(window,document,'script','dataLayer','GTM-PCPKR6W');</script>
<!-- End Google Tag Manager -->
</head>

<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PCPKR6W"
