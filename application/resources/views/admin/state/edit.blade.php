...
@section('content')
    <div class="card mb-3">
        <div class="card-body">
                    <h4><strong>Edit State</strong></h4>
            </div>
        </div>


    <form class="forms-sample" method="POST" action="{{ route('admin.states.update',$state) }}">
      @method('PATCH')
        @csrf
        <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="" class="form-select form-control">
                        <option value="1" @if ($state->status==1)
                            selected
                        @endif>Active</option>
                        <option value="0" @if ($state->status==0)
                          selected
              ...
              <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputUsername1"
                        placeholder="Enter meta title for desktop" name="meta_title"  value="{{$state->meta_title}}">
                </div>

                <div class="form-group">
                  <label for="exampleInputUsername1">Meta Keyword For Desktop</label>
                  <input type="text" class="form-control" id="exampleInputUsername1"
                      placeholder="Enter meta keyword for desktop" name="meta_keyword" value="{{$state->meta_keyword}}">
              </div>

              <div class="form-group">
                <label for="exampleInputUsername1">Meta Description For Desktop</label>
                <input type="text" class="form-control" id="exampleInputUsername1"
                    placeholder="Enter meta description for desktop" name="meta_description" value="{{$state->meta_description}}">
            </div>

            <div class="form-group">
              <label for="exampleInputUsername1">Meta Title For Mobile</label>
              <input type="text" class="form-control" id="exampleInputUsername1"
                  placeholder="Enter meta title for mobile" name="mobile_meta_title" value="{{$state->mobile_meta_title}}">
          </div>

          <div class="form-group">
            <label for="exampleInputUsername1">Meta Keyword For Mobile</label>
            <input type="text" class="form-control" id="exampleInputUsername1"
                placeholder="Enter meta keyword for mobile" name="mobile_meta_keyword" value="{{$state->mobile_meta_keyword}}">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputUsername1"
              placeholder="Enter meta description for mobile" name="mobile_meta_description" value="{{$state->mobile_meta_description}}">
      </div>
