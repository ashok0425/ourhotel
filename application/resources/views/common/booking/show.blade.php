...
<div class="card">
    ...
    <div class="card-body table-responsive pt-3">
        <div class="card-title d-flex justify-content-between">
            ...
            <div>
                <a href="{{route('admin.bookings.edit',$booking)}}" class="btb btn btn-primary rounded-0">Download Invoice</a>
        ...
        <div class="card-body">
            <table class="table">
                <tr>
                    ...
                    <td>
                        {{$booking->property?->name??$booking->hotel_data['name']}}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        {{$booking->property?->phone_number??$booking->hotel_data['phone_number']}}
                    </td>
                </tr>
