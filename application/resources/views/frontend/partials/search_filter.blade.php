...
<div class="">
        ...
        if (isset($_GET['city'])) {
            ...
            $city_name=DB::table('cities')->where('slug',request()->slug)->first();
        }
    ...
    <li class="list-style-disc">
        <a href="{{route('location.search',['city'=>$city_name->slug,'location'=>str_replace(' ','_',$item->location_name)])}}" target="_blank" class="custom-text-gray-2 custom-fw-800">
            {{$item->location_name}}
       </a>
    </li>
    ...
    <div class="more_content d-none">
        ...
        <ul class="my-1 px-3 list-style-disc">
          <li class="list-style-disc">
            <a href="{{route('location.search',['city'=>$city_name->slug,'location'=>str_replace(' ','_',$item->location_name)])}}" target="_blank" class="custom-text-gray-2 ">
                {{$item->location_name}}
           </a>
          </li>
        </ul>
