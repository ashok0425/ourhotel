            ...
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="form-group col-md-6">
                  ...
                  <br>
                  <img id="preview_thumb" src="{{getImageUrl($website->logo)}}" width="100" height="100" >
              ...
              <div class="form-group col-md-6">
                ...
                <br>
                <img id="mobile_thumbnail_preview" src="{{getImageUrl($website->fev)}}" width="100" height="100" >
                <div class="custom-file">
